    ...
    <div class="bg-white rounded-xl shadow-sm mx-4 border border-gray-100 overflow-hidden">
        ...
        <div class="px-6 pt-6 pb-4 border-b border-gray-100">
            <div class="space-y-4">
                ...
                <div>
                    <h1 class="text-2xl font-semibold text-gray-900">Detail Pengajuan Surat</h1>
                    <nav class="mt-1" aria-label="Breadcrumb">
                        <ol class="flex items-center gap-1.5 text-sm text-gray-700 font-medium">
                            <li>
                                <a href="{{ route('beranda.admin') }}" class="flex items-center gap-1 text-gray-700 hover:text-sky-700 transition-colors">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5 text-gray-500" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            <li>
                                <a href="{{ route('admin.layanan-surat.request.index') }}" class="flex items-center gap-1 text-gray-700 hover:text-sky-700 transition-colors">
                                    Pengajuan Surat
                                </a>
                            </li>
                            <li class="text-gray-400">/</li>
                            <li class="font-semibold text-gray-900">Detail</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            @if (auth()->user()->role === 'admin' && $pengajuanSurat->status === 'diajukan')
                <div class="flex flex-col sm:flex-row gap-3">
                    <button type="button"
                        ...
                        title="Setujui Pengajuan Surat Ini"
                        aria-label="Setujui Pengajuan Surat Ini"
                        class="w-full sm:w-auto inline-flex items-center gap-2 rounded-lg bg-emerald-800 hover:bg-emerald-900 px-4 py-2.5 text-sm font-bold text-white transition-colors shadow-sm">
                    ...
                    <button type="button" 
                        ...
                        title="Tolak Pengajuan Surat Ini"
                        aria-label="Tolak Pengajuan Surat Ini"
                        class="w-full sm:w-auto inline-flex items-center gap-2 rounded-lg bg-red-700 hover:bg-red-800 px-4 py-2.5 text-sm font-bold text-white transition-colors shadow-sm">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor">
                    ...
                    <a href="{{ route('admin.layanan-surat.request.print', $pengajuanSurat->id_pengajuan_surat) }}"
                        ...
                        class="w-full sm:w-auto inline-flex items-center gap-2 rounded-lg bg-purple-700 hover:bg-purple-800 px-4 py-2.5 text-sm font-bold text-white transition-colors shadow-sm">
                ...
                <div class="space-y-6">
                    <div class="flex flex-wrap gap-3">
                        ...
                        <a href="{{ route('admin.layanan-surat.request.print', $pengajuanSurat->id_pengajuan_surat) }}"
                            ...
                            aria-label="Pratinjau Surat Resmi"
                            class="inline-flex items-center gap-2 rounded-lg bg-purple-700 hover:bg-purple-800 px-4 py-2.5 text-sm font-bold text-white transition-colors shadow-sm">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        ...
                        <a href="{{ route('admin.layanan-surat.request.download', $pengajuanSurat->id_pengajuan_surat) }}"
                            target="_blank"
                            title="Unduh Surat"
                            aria-label="Unduh Surat"
                            class="inline-flex items-center gap-2 rounded-lg bg-sky-700 hover:bg-sky-800 px-4 py-2.5 text-sm font-bold text-white transition-colors shadow-sm">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                    ...
                    <div class="mt-6 p-4 bg-gray-50 rounded-xl border border-gray-200">
                        ...
                        <form action="{{ route('admin.layanan-surat.request.upload-scan', $pengajuanSurat->id_pengajuan_surat) }}" method="POST" enctype="multipart/form-data" class="space-y-3">
                            ...
                            <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
                                <label for="file_pdf_upload" class="sr-only">Pilih File Scan TTD Basah</label>
                                <input id="file_pdf_upload" type="file" name="file_pdf" accept=".pdf,image/png,image/jpeg,image/jpg" required aria-label="Pilih File Scan TTD Basah" title="Pilih File Scan TTD Basah"
                                    class="block w-full text-xs text-gray-700 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-xs file:font-semibold file:bg-sky-50 file:text-sky-800 hover:file:bg-sky-100 border border-gray-300 rounded-lg p-1 bg-white">
                                <button type="submit" title="Unggah File Surat" aria-label="Unggah File Surat"
                                    class="inline-flex items-center justify-center gap-2 rounded-lg bg-sky-700 hover:bg-sky-800 px-4 py-2 text-xs font-bold text-white transition-colors shadow-sm">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
