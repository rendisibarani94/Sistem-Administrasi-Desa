<x-layouts.layouts>
    ...
    <div class="bg-white rounded-lg shadow-md mx-4">
        <div class="flex justify-between">
            <h1 class="text-3xl font-semibold mt-6 mb-6">Notifikasi Surat</h1>
        </div>
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="ms-1 text-sm font-semibold text-gray-500 md:ms-2">Notifikasi Surat</span>
                        </div>
                    </li>
                </ol>
            </nav>
        ...
        <div class="flex flex-wrap justify-between items-center border-2 border-gray-300 rounded-sm my-6 p-4 gap-4 sm:justify-between">
            ...
            <div class="relative w-full sm:w-72">
                ...
                <input type="search" class="block w-full sm:w-72 p-3 ps-10 text-sm text-gray-900 border border-gray-400 rounded-lg bg-gray-50 focus:ring-sky-500 focus:border-sky-500" placeholder="Cari Notifikasi" />
            </div>
        </div>
            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 table-fixed">
                <thead class="text-xs text-gray-700 uppercase bg-gray-100">
                    <tr>
                        ...
                        <th scope="col" class="w-auto px-6 py-4 font-semibold border-b-3 border-gray-500">Pesan</th>
                        <th scope="col" class="w-auto px-6 py-4 font-semibold border-b-3 border-gray-500">Waktu</th>
                        <th scope="col" class="w-auto px-6 py-4 font-semibold border-b-3 border-gray-500 text-center">Aksi</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td colspan="4" class="px-6 py-4 text-center text-gray-500 font-semibold">Data belum tersedia.</td>
                    </tr>
                </tbody>
            </table>
