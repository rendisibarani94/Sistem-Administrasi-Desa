<div>
    ...
    <div class="bg-sky-600 my-4 mx-6 rounded-sm p-2 ">
        <h5 class="text-xl text-white font-semibold text-center">Formulir Edit Aparatur Desa</h5>
    </div>
        ...
        <form wire:submit.prevent="update">
            ...
            <div class="grid gap-6 mb-6 md:grid-cols-2">
                ...
                <div class="input-component">
                    ...
                    @if($existingFoto)
                    <div class="mb-4">
                        <img src="{{ asset('storage/' . $existingFoto) }}" alt="Current landing page image" class="mx-auto w-96 h-auto object-cover border border-gray-300">
                    </div>
                    @endif
            ...
            <div class="flex justify-between mt-6">
                ...
                <button type="submit" class="text-white bg-green-700 hover:bg-green-800 focus:ring-2 focus:outline-none focus:ring-green-300 font-medium rounded-sm text-sm w-full sm:w-auto px-5 py-2.5 text-center cursor-pointer">Edit Aparatur Desa</button>
            </div>
        </form>
    </div>
</div>
