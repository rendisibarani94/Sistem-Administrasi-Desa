<div>
    ...
    <div class="bg-sky-600 my-4 mx-6 rounded-sm p-2 ">
        <h5 class="text-xl text-white font-semibold text-center">Formulir Tambah Peraturan Desa</h5>
    </div>
        ...
        <form wire:submit.prevent="store">
            <div class="grid gap-6 mb-6 md:grid-cols-2">
                ...
                <div class="input-component">
                    ...
                    <select id="jenis_peraturan" wire:model.live="jenis_peraturan" class="bg-gray-50 [&>option]:font-medium border text-gray-900 font-medium text-sm rounded-sm block w-full p-2.5 @error('jenis_peraturan') border-red-500 focus:ring-red-500 focus:border-red-500 @else border-gray-400 focus:ring-sky-500 focus:border-sky-500 @enderror">
                ...
                <div class="input-component">
                    ...
                    <input type="text" id="tujuan_dilaporkan" wire:model.live="tujuan_dilaporkan" class="bg-gray-50 border text-gray-900 font-medium text-sm rounded-sm block w-full p-2.5 placeholder:text-slate-600 @error('tujuan_dilaporkan') border-red-500 focus:ring-red-500 focus:border-red-500 @else border-gray-400 focus:ring-sky-500 focus:border-sky-500 @enderror" placeholder="Masukan Tujuan Peraturan Desa Dilaporkan" autocomplete="off" />
                    <div class="h-0.25">
                ...
                <div class="input-component">
                    ...
                    <input type="date" id="tanggal_dilaporkan" wire:model.live="tanggal_dilaporkan" class="bg-gray-50 border text-gray-900 font-medium text-sm rounded-sm block w-full p-2.5 placeholder:text-slate-600 @error('tanggal_dilaporkan') border-red-500 focus:ring-red-500 focus:border-red-500 @else border-gray-400 focus:ring-sky-500 focus:border-sky-500 @enderror" autocomplete="off" />
                    <div class="h-0.25">
                ...
                <div class="input-component">
                    ...
                    <textarea id="uraian_singkat" wire:model.live="uraian_singkat" class="bg-gray-50 border text-gray-900 font-medium text-sm rounded-sm block w-full h-26 p-2.5 placeholder:text-slate-600 @error('uraian_singkat') border-red-500 focus:ring-red-500 focus:border-red-500 @else border-gray-400 focus:ring-sky-500 focus:border-sky-500 @enderror" placeholder="Masukan Uraian Singkat Peraturan Desa" autocomplete="off"></textarea>
                    <div class="h-0.25">
            ...
            <div class="flex justify-between mt-6">
                <a href="{{ route('PeraturanDesa') }}" class="text-white text-center bg-gray-500 hover:bg-gray-600 focus:ring-2 focus:outline-none focus:ring-sky-600 font-medium rounded-sm text-sm w-full sm:w-auto px-5 py-2.5 cursor-pointer">Kembali</a>

                <button type="submit" class="text-white bg-sky-700 hover:bg-sky-800 focus:ring-2 focus:outline-none focus:ring-sky-300 font-medium rounded-sm text-sm w-full sm:w-auto px-5 py-2.5 text-center cursor-pointer">Tambah Peraturan Desa</button>
            </div>
        </form>
    </div>
</div>
