    ...
    <div class="mx-6 mt-8">
        <form wire:submit.prevent="store">
            <div class="grid gap-6 mb-6 md:grid-cols-4">
                    ...
                    <div class="flex">
                        <div class="input-component flex-1 mr-2 cursor-pointer">
                            <div class="flex items-center px-2.5 border cursor-pointer rounded-sm border-gray-400">
                                <input id="bordered-radio-1" name="jenis_surat" type="radio" value="Surat Masuk" wire:model.live="jenis_surat" class="w-4 h-4 text-blue-600 cursor-pointer bg-gray-100 focus:ring-blue-600 ring-offset-gray-800 focus:ring-2 border-gray-400">
                                <label for="bordered-radio-1" class="w-full py-2.5 ml-2 text-sm font-medium text-gray-900 cursor-pointer">Surat Masuk</label>
                            </div>
                        </div>
                        <div class="input-component flex-1 mr-2 cursor-pointer">
                            <div class="flex items-center px-2.5 border cursor-pointer rounded-sm border-gray-400">
                                <input id="bordered-radio-2" name="jenis_surat" type="radio" value="Surat Keluar" wire:model.live="jenis_surat" class="w-4 h-4 text-blue-600 cursor-pointer bg-gray-100 focus:ring-blue-600 ring-offset-gray-800 focus:ring-2 border-gray-400">
                                <label for="bordered-radio-2" class="w-full py-2.5 ml-2 text-sm font-medium text-gray-900 cursor-pointer">Surat Keluar</label>
                            </div>
                        </div>
                        <div class="input-component flex-1 mr-2 cursor-pointer">
                            <div class="flex items-center px-2.5 border cursor-pointer rounded-sm border-gray-400">
                                <input id="bordered-radio-3" name="jenis_surat" type="radio" value="Surat Ekspedisi" wire:model.live="jenis_surat" class="w-4 h-4 text-blue-600 cursor-pointer bg-gray-100 focus:ring-blue-600 ring-offset-gray-800 focus:ring-2 border-gray-400">
                ...
                <div class="md:col-span-1">
                    <div class="input-component">
                        ...
                        <input type="date" id="tanggal_pengiriman_penerimaan" wire:model.live="tanggal_pengiriman_penerimaan" class="bg-gray-50 border text-gray-900 font-medium text-sm rounded-sm block w-full p-2.5 placeholder:text-slate-600 @error('tanggal_pengiriman_penerimaan') border-red-500 focus:ring-red-500 focus:border-red-500 @else border-gray-400 focus:border-blue-500 @enderror" autocomplete="off" />
                        <div class="h-0.25">
                ...
                <div class="md:col-span-1">
                    <div class="input-component">
                        ...
                        <input type="date" id="tanggal_surat" wire:model.live="tanggal_surat" class="bg-gray-50 border text-gray-900 font-medium text-sm rounded-sm block w-full p-2.5 placeholder:text-slate-600 @error('tanggal_surat') border-red-500 focus:ring-red-500 focus:border-red-500 @else border-gray-400 focus:border-blue-500 @enderror" autocomplete="off" />
                        <div class="h-0.25">
                            @error('tanggal_surat')
                            <span class="errorMsg text-red-500 font-semibold text-xs italic">{{ "*".$message }}</span>
                            @enderror
            ...
            <div class="flex justify-between mt-6">
                ...
                <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-2 focus:outline-none focus:ring-blue-300 font-medium rounded-sm text-sm w-full sm:w-auto px-5 py-2.5 text-center cursor-pointer">Tambah Surat Keluar</button>
            </div>
        </form>
    </div>
</div>
