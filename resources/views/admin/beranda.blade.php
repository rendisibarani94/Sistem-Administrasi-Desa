<div class="p-4">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        ...
        <a href="{{ route('PeraturanDesa') }}">
            <div class="bg-white rounded-xl shadow-md overflow-hidden border-3 border-teal-600 transition-all hover:shadow-lg">
                <div class="p-5">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-teal-700">{{ $stats['peraturan_desa'] }}</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="p-5">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-teal-700">{{ $stats['keputusan_kepala_desa'] }}</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="p-5">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-teal-700">{{ $stats['aparatur_desa'] }}</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="p-5">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-teal-700">{{ $stats['tanah_kas_desa'] }}</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="p-5">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-teal-700">{{ $stats['tanah_desa'] }}</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="p-5">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-teal-700">{{ $stats['inventaris_desa'] }}</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="p-5">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-teal-700">{{ $stats['agenda_surat'] }}</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="p-5">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-teal-700">{{ $stats['penduduk'] }}</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="p-5">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-teal-700">{{ $stats['kartu_keluarga'] }}</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="p-5">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-teal-700">{{ $stats['penduduk_sementara'] }}</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="p-5">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-teal-700">{{ $stats['kader_pemberdayaan'] }}</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="p-5">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-teal-700">{{ $stats['pembangunan'] }}</p>
                        </div>
                    </div>
                </div>
            </div>
