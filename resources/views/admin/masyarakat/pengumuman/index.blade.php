<div>
    ...
    <div class="mx-4">
        ...
        <div class="flex flex-wrap justify-between items-center border-2 border-gray-300 rounded-sm my-6 p-4 gap-4 sm:justify-between">
            <!-- Button -->
            <a href="{{ route('admin.pengumuman.create') }}" class="cursor-pointer bg-teal-700 text-white focus:ring-2 focus:outline-none focus:ring-teal-600 font-bold py-2 px-4 rounded flex items-center space-x-2 w-full sm:w-auto">
            ...
            <div class="relative w-full sm:w-72">
                ...
                <input type="search" type="search" wire:model.live="search" autocomplete="off" class="block w-full sm:w-72 p-3 ps-10 text-sm text-gray-900 border border-gray-400 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500" placeholder="Cari Pengumuman" required />
            </div>
        </div>
                ...
                <tbody class="bg-white divide-y divide-gray-200" id="tableBody">
                    ...
                    <tr class="hover:bg-gray-300 transition duration-200">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap font-semibold flex justify-center space-x-4">
                            ...
                            <a href="{{ route('admin.pengumuman.edit', $item->id_pengumuman) }}" class="text-blue-600 hover:text-blue-900 font-medium transition flex items-center space-x-1.5 cursor-pointer">
