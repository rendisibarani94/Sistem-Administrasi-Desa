<div>
    ...
    <div class="bg-teal-700 my-4 mx-6 rounded-sm p-2">
        <h5 class="text-xl text-white font-semibold text-center">Formulir Tambah Pengumuman Desa</h5>
    </div>
        ...
        <form wire:submit.prevent="store">
            <div class="grid gap-6 mb-6 md:grid-cols-2">
                <div class="input-component">
                    ...
                    <div class="mb-4">
                        <img src="{{ asset('storage/' . $existingGambarPengumuman) }}" alt="gambar pengumuman terbaru" class="mx-auto w-96 h-auto object-cover border border-gray-300">
                    </div>
                    @endif
                ...
                <div class="input-component">
                    ...
                    <input type="text" id="judul" wire:model.live="judul" class="bg-gray-50 border text-gray-900 font-medium text-sm rounded-sm block w-full p-2.5 placeholder:text-slate-600 @error('judul') border-red-500 focus:ring-red-500 focus:border-red-500 @else border-gray-400 focus:ring-blue-500 focus:border-blue-500 @enderror" placeholder="Masukan Judul Pengumuman " autocomplete="off" />
                    <div class="h-0.25">
            ...
            <div class="flex justify-between mt-6">
                <a href="{{ route('admin.pengumuman') }}" class="text-white text-center bg-teal-700 hover:bg-teal-800 focus:ring-2 focus:outline-none focus:ring-teal-600 font-medium rounded-sm text-sm w-full sm:w-auto px-5 py-2.5 cursor-pointer">Kembali</a>

                <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-2 focus:outline-none focus:ring-blue-300 font-medium rounded-sm text-sm w-full sm:w-auto px-5 py-2.5 text-center cursor-pointer">Tambah Pengumuman Desa</button>
            </div>
        </form>
    </div>
</div>
