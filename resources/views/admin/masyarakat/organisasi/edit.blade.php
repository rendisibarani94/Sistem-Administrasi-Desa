    ...
    <div class="mx-6 mt-8">
        <form wire:submit.prevent="update">
            ...
            <div class="flex justify-between mt-6">
                ...
                <button type="submit" class="text-white bg-blue-700 hover:bg-blue-8z00 focus:ring-2 focus:outline-none focus:ring-blue-300 font-medium rounded-sm text-sm w-full sm:w-auto px-5 py-2.5 text-center cursor-pointer">Edit Organisasi Desa</button>
            </div>
        </form>
    </div>
</div>
