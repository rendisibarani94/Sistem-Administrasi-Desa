<div>
    ...
    <div class="bg-sky-600 my-4 mx-6 rounded-sm p-2">
        <h5 class="text-xl text-white font-semibold text-center">Formulir Edit Organisasi Desa</h5>
    </div>
    ...
    <div class="mx-6 mt-8">
        <form wire:submit.prevent="update">
            <div class="cointainer space-y-6">
                <div class="grid gap-6 mb-6 md:grid-cols-2">
                    <div class="input-component">
                        ...
                        <input type="text" id="nama_organisasi" wire:model.live="nama_organisasi" class="bg-gray-50 border text-gray-900 font-medium text-sm rounded-sm block w-full p-2.5 placeholder:text-slate-600 @error('nama_organisasi') border-red-500 focus:ring-red-500 focus:border-red-500 @else border-gray-400 focus:ring-sky-500 focus:border-sky-500 @enderror" placeholder="Masukan Nama Organisasi Desa " autocomplete="off" />
                        <div class="h-0.25">
                    ...
                    <div class="input-component">
                        ...
                        <input type="date" id="tanggal_berdiri" wire:model.live.debounce.500ms="tanggal_berdiri" class="bg-gray-50 border text-gray-900 font-medium text-sm rounded-sm block w-full p-2.5 @error('tanggal_berdiri') border-red-500 focus:ring-red-500 focus:border-red-500 @else border-gray-400 focus:ring-sky-500 focus:border-sky-500 @enderror" placeholder="Masukan Tanggal Beridiri Organisasi" autocomplete="off" />
                        <div class="h-0.25">
                    ...
                    <div class="input-component">
                        ...
                        <input type="text" id="ketua" wire:model.live="ketua" class="bg-gray-50 border text-gray-900 font-medium text-sm rounded-sm block w-full p-2.5 placeholder:text-slate-600 @error('ketua') border-red-500 focus:ring-red-500 focus:border-red-500 @else border-gray-400 focus:ring-sky-500 focus:border-sky-500 @enderror" placeholder="Masukan Nama Ketua Organisasi " autocomplete="off" />
                        <div class="h-0.25">
                    ...
                    <div class="input-component">
                        ...
                        <div class="mb-4">
                            <img src="{{ asset('storage/' . $existingFotoKetua) }}" alt="Current landing page image" class="mx-auto w-96 h-auto object-cover border border-gray-300">
                        </div>
                        @endif
                        ...
                        @endif
                        <!-- File Input -->
                        <input id="foto_ketua" wire:model="foto_ketua" accept="image/*" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-sm cursor-pointer bg-gray-50 focus:outline-none file:cursor-pointer file:bg-sky-600 file:border-0 file:me-4 file:py-2 file:px-4 file:text-sm file:text-white file:font-semibold @error('foto_ketua') border-red-500 @enderror" type="file">
                        {{-- Error Message --}}
                        <div class="h-0.25">
                            @error('foto_ketua')
                    ...
                    <div class="input-component">
                        ...
                        <input type="text" id="sekretaris" wire:model.live="sekretaris" class="bg-gray-50 border text-gray-900 font-medium text-sm rounded-sm block w-full p-2.5 placeholder:text-slate-600 @error('sekretaris') border-red-500 focus:ring-red-500 focus:border-red-500 @else border-gray-400 focus:ring-sky-500 focus:border-sky-500 @enderror" placeholder="Masukan Nama sekretaris Organisasi " autocomplete="off" />
                        <div class="h-0.25">
                    ...
                    <div class="input-component">
                        ...
                        <div class="mb-4">
                            <img src="{{ asset('storage/' . $existingFotoSekretaris) }}" alt="Current landing page image" class="mx-auto w-96 h-auto object-cover border border-gray-300">
                        </div>
                        @endif
                        <!-- Show preview of new image if selected -->
                        @if($foto_sekretaris)
                        ...
                        @endif
                        <!-- File Input -->
                        <input id="foto_sekretaris" wire:model="foto_sekretaris" accept="image/*" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-sm cursor-pointer bg-gray-50 focus:outline-none file:cursor-pointer file:bg-sky-600 file:border-0 file:me-4 file:py-2 file:px-4 file:text-sm file:text-white file:font-semibold @error('foto_sekretaris') border-red-500 @enderror" type="file">
                        {{-- Error Message --}}
                        <div class="h-0.25">
                    ...
                    <div class="input-component">
                        ...
                        <input type="text" id="bendahara" wire:model.live="bendahara" class="bg-gray-50 border text-gray-900 font-medium text-sm rounded-sm block w-full p-2.5 placeholder:text-slate-600 @error('bendahara') border-red-500 focus:ring-red-500 focus:border-red-500 @else border-gray-400 focus:ring-sky-500 focus:border-sky-500 @enderror" placeholder="Masukan Nama Bendahara Organisasi " autocomplete="off" />
                        <div class="h-0.25">
                    ...
                    <div class="input-component">
                        ...
                        <div class="mb-4">
                            <img src="{{ asset('storage/' . $existingFotoBendahara) }}" alt="Current landing page image" class="mx-auto w-96 h-auto object-cover border border-gray-300">
                        </div>
                        @endif
                        <!-- Show preview of new image if selected -->
                        @if($foto_bendahara)
                        ...
                        @endif
                        <!-- File Input -->
                        <input id="foto_bendahara" wire:model="foto_bendahara" accept="image/*" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-sm cursor-pointer bg-gray-50 focus:outline-none file:cursor-pointer file:bg-sky-600 file:border-0 file:me-4 file:py-2 file:px-4 file:text-sm file:text-white file:font-semibold @error('foto_bendahara') border-red-500 @enderror" type="file">
                        {{-- Error Message --}}
                        <div class="h-0.25">
                    ...
                    <div class="input-component">
                        ...
                        <input type="text" id="alamat" wire:model.live="alamat" class="bg-gray-50 border text-gray-900 font-medium text-sm rounded-sm block w-full p-2.5 placeholder:text-slate-600 @error('alamat') border-red-500 focus:ring-red-500 focus:border-red-500 @else border-gray-400 focus:ring-sky-500 focus:border-sky-500 @enderror" placeholder="Masukan Alamat Organisasi Desa " autocomplete="off" />
                        <div class="h-0.25">
                    ...
                    <div class="input-component">
                        ...
                        <div class="mb-4">
                            <img src="{{ asset('storage/' . $existingLogoOrganisasi) }}" alt="Current landing page image" class="mx-auto w-96 h-auto object-cover border border-gray-300">
                        </div>
                        @endif
                        <!-- Show preview of new image if selected -->
                        @if($logo_organisasi)
                        ...
                        @endif
                        <!-- File Input -->
                        <input id="logo_organisasi" wire:model="logo_organisasi" accept="image/*" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-sm cursor-pointer bg-gray-50 focus:outline-none file:cursor-pointer file:bg-sky-600 file:border-0 file:me-4 file:py-2 file:px-4 file:text-sm file:text-white file:font-semibold @error('logo_organisasi') border-red-500 @enderror" type="file">
                        {{-- Error Message --}}
                        <div class="h-0.25">
            ...
            <div class="flex justify-between mt-6">
                <a href="{{ route('admin.organisasi') }}" class="text-white text-center bg-gray-500 hover:bg-gray-600 focus:ring-2 focus:outline-none focus:ring-gray-600 font-medium rounded-sm text-sm w-full sm:w-auto px-5 py-2.5 cursor-pointer">Kembali</a>

                <button type="submit" class="text-white bg-green-700 hover:bg-green-8z00 focus:ring-2 focus:outline-none focus:ring-green-300 font-medium rounded-sm text-sm w-full sm:w-auto px-5 py-2.5 text-center cursor-pointer">Edit Organisasi Desa</button>
            </div>
        </form>
    </div>
</div>
