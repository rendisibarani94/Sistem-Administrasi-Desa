        ...
        <form wire:submit.prevent="save" enctype="multipart/form-data" class="space-y-6">
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <div class="mb-6">
                    ...
                    <!-- File Input -->
                    <input id="gambar_landing_page" wire:model="gambar_landing_page" accept="image/*" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-sm cursor-pointer bg-gray-50 focus:outline-none file:cursor-pointer file:bg-blue-600 file:border-0 file:me-4 file:py-2 file:px-4 file:text-sm file:text-white file:font-semibold @error('gambar_landing_page') border-red-500 @enderror" type="file">
                    ...
                    <div wire:loading wire:target="gambar_landing_page" class="text-blue-500 text-sm mt-2">
                        Uploading...
                    </div>
                </div>

                <div class="input-component">
                    <label for="editor-container" class="block mb-2 text-sm font-semibold text-gray-950">Deskripsi Landing Page</label>
                    <div wire:ignore>
                        <!-- Editor container -->
                        ...
                        <input type="hidden" id="deskripsi-input" wire:model="deskripsi_beranda">
                    </div>
                    <div class="h-0.25">
                        @error('deskripsi_beranda')
                        <span class="errorMsg text-red-500 font-semibold text-xs italic">{{ "*".$message }}</span>
                        @enderror
                    </div>
                </div>
                ...
                <div class="input-component">
                    <label for="deskripsi-singkat-desa-container" class="block mb-2 text-sm font-semibold text-gray-950">Deskripsi Landing Page</label>
                    <div wire:ignore>
                        <!-- Editor container -->
                ...
                <div class="input-component">
                    <label for="deskripsi-singkat-organisasi-container" class="block mb-2 text-sm font-semibold text-gray-950">Deskripsi Landing Page</label>
                    <div wire:ignore>
                        <!-- Editor container -->
                ...
                <div class="flex justify-between mt-6">
                    <a href="/admin" class="text-white text-center bg-teal-700 hover:bg-teal-800 focus:ring-2 focus:outline-none focus:ring-teal-600 font-medium rounded-sm text-sm w-full sm:w-auto px-5 py-2.5 cursor-pointer">Kembali</a>
                    <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-2 focus:outline-none focus:ring-blue-300 font-medium rounded-sm text-sm w-full sm:w-auto px-5 py-2.5 text-center cursor-pointer">Ubah Data</button>
                </div>
        </form>
    </div>
</div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        quill.on('text-change', function() {
            ...
            @this.set('deskripsi_beranda', content);
        });
        ...
        Livewire.hook('message.processed', (message, component) => {
            if (component.id === @this.__id) {
                ...
                const newContent = component.get('deskripsi_beranda');
