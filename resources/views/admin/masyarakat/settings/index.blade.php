        ...
        <form wire:submit.prevent="save" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 mt-8">
                ...
                <div class="space-y-4">
                    ...
                    <!-- Deskripsi Footer -->
                    {{-- <div>
                        <label for="deskripsi_footer" class="block mb-2 text-sm font-semibold text-gray-950">Deskripsi Footer</label>
                        <textarea id="deskripsi_footer" wire:model.live="deskripsi_footer" class="bg-gray-50 border text-gray-900 font-medium text-sm rounded-sm block w-full h-26 p-2.5 placeholder:text-slate-600 @error('deskripsi_footer') border-red-500 focus:ring-red-500 focus:border-red-500 @else border-gray-400 focus:ring-blue-500 focus:border-blue-500 @enderror" placeholder="Masukkan Deskripsi Footer" autocomplete="off"></textarea>
                        <div class="h-0.25">
                            @error('deskripsi_footer') <span class="errorMsg text-red-500 font-semibold text-xs italic">{{ "*".$message }}</span> @enderror
                        </div>
                    </div> --}}
