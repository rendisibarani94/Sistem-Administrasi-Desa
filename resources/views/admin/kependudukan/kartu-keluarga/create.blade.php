            ...
            <div class="step {{ $currentStep != 1 ? 'hidden' : '' }}">
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-2">
                    ...
                    <div class="input-component">
                        ...
                        <input type="date" id="tanggal_keluar" wire:model="tanggal_keluar" class="bg-gray-50 border text-gray-900 font-medium text-sm rounded-sm block w-full p-2.5 @error('tanggal_keluar') border-red-500 focus:ring-red-500 focus:border-red-500 @else border-gray-400 focus:ring-sky-500 focus:border-sky-500 @enderror" placeholder="Masukan Tanggal Penambahan Penduduk " autocomplete="off" />
                        <div class="h-0.25">
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-4">
                    ...
                    <div class="md:col-span-1">
                        ...
                        <input type="text" id="rt" wire:model="rt" class="bg-gray-50 border text-gray-900 font-medium text-sm rounded-sm block w-full p-2.5 @error('rt') border-red-500 focus:ring-red-500 focus:border-red-500 @else border-gray-400 focus:ring-sky-500 focus:border-sky-500 @enderror" placeholder="Masukan RT " autocomplete="off" />
                        <div class="h-0.25">
                    ...
                    <div class="md:col-span-1">
                        ...
                        <input type="text" id="rw" wire:model="rw" class="bg-gray-50 border text-gray-900 font-medium text-sm rounded-sm block w-full p-2.5 @error('rw') border-red-500 focus:ring-red-500 focus:border-red-500 @else border-gray-400 focus:ring-sky-500 focus:border-sky-500 @enderror" placeholder="Masukan RW " autocomplete="off" />
                        <div class="h-0.25">
                ...
                <div class="grid grid-cols-12 grid-rows-1 gap-4">
                    <div class="col-span-2">
                        ...
                        <input type="text" id="desa_kelurahan" wire:model="desa_kelurahan" class="bg-gray-50 border text-gray-900 font-medium text-sm rounded-sm block w-full p-2.5 @error('desa_kelurahan') border-red-500 focus:ring-red-500 focus:border-red-500 @else border-gray-400 focus:ring-sky-500 focus:border-sky-500 @enderror" placeholder="Masukan Desa/Kelurahan " autocomplete="off" />
                        <div class="h-0.25">
                    ...
                    <div class="col-span-2 col-start-3">
                        ...
                        <input type="text" id="kecamatan" wire:model="kecamatan" class="bg-gray-50 border text-gray-900 font-medium text-sm rounded-sm block w-full p-2.5 @error('kecamatan') border-red-500 focus:ring-red-500 focus:border-red-500 @else border-gray-400 focus:ring-sky-500 focus:border-sky-500 @enderror" placeholder="Masukan Kecamatan " autocomplete="off" />
                        <div class="h-0.25">
                    ...
                    <div class="col-span-2 col-start-5">
                        ...
                        <input type="text" id="kode_pos" wire:model="kode_pos" class="bg-gray-50 border text-gray-900 font-medium text-sm rounded-sm block w-full p-2.5 @error('kode_pos') border-red-500 focus:ring-red-500 focus:border-red-500 @else border-gray-400 focus:ring-sky-500 focus:border-sky-500 @enderror" placeholder="Masukan Kode Pos " autocomplete="off" />
                        <div class="h-0.25">
                    ...
                    <div class="col-span-3 col-start-7">
                        ...
                        <input type="text" id="kabupaten_kota" wire:model="kabupaten_kota" class="bg-gray-50 border text-gray-900 font-medium text-sm rounded-sm block w-full p-2.5 @error('kabupaten_kota') border-red-500 focus:ring-red-500 focus:border-red-500 @else border-gray-400 focus:ring-sky-500 focus:border-sky-500 @enderror" placeholder="Masukan Kabupaten/Kota " autocomplete="off" />
                        <div class="h-0.25">
