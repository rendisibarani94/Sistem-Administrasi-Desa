    ...
    <div class="mx-6 mt-8">
        <form wire:submit.prevent="update">
            ...
            <div class="flex justify-between mt-6">
                <a href="{{ route('kartuKeluarga') }}" class="text-white bg-teal-700 hover:bg-teal-800 focus:ring-4 focus:outline-none focus:ring-teal-300 font-medium rounded-sm text-sm w-full sm:w-auto px-5 py-2.5 text-center cursor-pointer">Kembali</a>
                
                <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-sm text-sm w-full sm:w-auto px-5 py-2.5 text-center cursor-pointer">Ubah Kartu Keluarga</button>
            </div>
        </form>
    </div>
</div>
