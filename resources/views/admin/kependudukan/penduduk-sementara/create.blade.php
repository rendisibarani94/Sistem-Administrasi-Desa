<div>
    ...
    <div class="bg-teal-700 my-4 mx-6 rounded-sm p-2">
        <h5 class="text-xl text-white font-semibold text-center">Formulir Tambah Penduduk Sementara</h5>
    </div>
        ...
        <form wire:submit.prevent="store">
            ...
            <div class="grid gap-6 mb-6 md:grid-cols-4">
                <div class="md:col-span-2">
                    <label for="nomor_pengenal" class="block mb-2 text-sm font-semibold text-gray-950">Nomor Pengenal</label>
                    <input type="text" id="nomor_pengenal" wire:model.live="nomor_pengenal" class="bg-gray-50 border text-gray-900 font-medium text-sm rounded-sm block w-full p-2.5 placeholder:text-slate-600 @error('nomor_pengenal') border-red-500 focus:ring-red-500 focus:border-red-500 @else border-gray-400 focus:ring-blue-500 focus:border-blue-500 @enderror" placeholder="Masukan Nomor Pengenal " autocomplete="off" />
                    <div class="h-0.25">
                        @error('nomor_pengenal') <span class="errorMsg text-red-500 font-semibold text-xs italic">{{ "*".$message }}</span> @enderror
                    </div>
                </div>
            ...
            <div class="grid gap-6 mb-6 md:grid-cols-2">
                ...
                <div class="input-component">
                    ...
                    <input type="text" id="asal" wire:model.live="asal" class="bg-gray-50 border text-gray-900 font-medium text-sm rounded-sm block w-full p-2.5 placeholder:text-slate-600 @error('asal') border-red-500 focus:ring-red-500 focus:border-red-500 @else border-gray-400 focus:ring-blue-500 focus:border-blue-500 @enderror" placeholder="Masukan Alamat Asal Kedatangan" autocomplete="off" />
                    <div class="h-0.25">
                ...
                <div class="input-component">
                    ...
                    <input type="text" id="tokoh_tujuan" wire:model.live="tokoh_tujuan" class="bg-gray-50 border text-gray-900 font-medium text-sm rounded-sm block w-full p-2.5 placeholder:text-slate-600 @error('tokoh_tujuan') border-red-500 focus:ring-red-500 focus:border-red-500 @else border-gray-400 focus:ring-blue-500 focus:border-blue-500 @enderror" placeholder="Masukan Tokoh Tujuan Kedatangan" autocomplete="off" />
                    <div class="h-0.25">
                ...
                <div class="input-component">
                    ...
                    <input type="text" id="alamat_tujuan" wire:model.live="alamat_tujuan" class="bg-gray-50 border text-gray-900 font-medium text-sm rounded-sm block w-full p-2.5 placeholder:text-slate-600 @error('alamat_tujuan') border-red-500 focus:ring-red-500 focus:border-red-500 @else border-gray-400 focus:ring-blue-500 focus:border-blue-500 @enderror" placeholder="Masukan Alamat Tujuan Kedatangan" autocomplete="off" />
                    <div class="h-0.25">
                ...
                <div class="input-component">
                    ...
                    <input type="date" id="tanggal_kedatangan" wire:model.live="tanggal_kedatangan" class="bg-gray-50 border text-gray-900 font-medium text-sm rounded-sm block w-full p-2.5 placeholder:text-slate-600 @error('tanggal_kedatangan') border-red-500 focus:ring-red-500 focus:border-red-500 @else border-gray-400 focus:ring-blue-500 focus:border-blue-500 @enderror" placeholder="Masukan Tanggal Kedatangan " autocomplete="off" />
                    <div class="h-0.25">
                ...
                <div class="input-component">
                    ...
                    <textarea id="maksud_kedatangan" wire:model.live="maksud_kedatangan" class="bg-gray-50 border text-gray-900 font-medium text-sm rounded-sm block w-full h-26 p-2.5 placeholder:text-slate-600 @error('maksud_kedatangan') border-red-500 focus:ring-red-500 focus:border-red-500 @else border-gray-400 focus:ring-blue-500 focus:border-blue-500 @enderror" placeholder="Masukan Maksud Kedatangan" autocomplete="off"></textarea>
                    <div class="h-0.25">
            ...
            <div class="flex justify-between mt-6">
                <a href="{{ route('pendudukSementara') }}" class="text-white text-center bg-teal-700 hover:bg-teal-800 focus:ring-2 focus:outline-none focus:ring-teal-600 font-medium rounded-sm text-sm w-full sm:w-auto px-5 py-2.5 cursor-pointer">Kembali</a>

                <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-2 focus:outline-none focus:ring-blue-300 font-medium rounded-sm text-sm w-full sm:w-auto px-5 py-2.5 text-center cursor-pointer">Tambah Penduduk Sementara</button>
            </div>
