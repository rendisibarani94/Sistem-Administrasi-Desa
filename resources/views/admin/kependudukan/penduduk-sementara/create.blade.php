        ...
        <form wire:submit.prevent="store">
            ...
            <div class="grid gap-6 mb-6 md:grid-cols-4">
                <div class="md:col-span-2">
                    ...
                    <input type="text" id="nomor_pengenal" wire:model.live="nomor_pengenal" class="bg-gray-50 border text-gray-900 font-medium text-sm rounded-sm block w-full p-2.5 placeholder:text-slate-600 @error('nomor_pengenal') border-red-500 focus:ring-red-500 focus:border-red-500 @else border-gray-400 focus:ring-sky-500 focus:border-sky-500 @enderror" placeholder="Masukan Nomor Pengenal " autocomplete="off" />
                    <div class="h-0.25">
            ...
            <div class="flex justify-between mt-6">
                ...
                <button type="submit" class="text-white bg-sky-700 hover:bg-sky-800 focus:ring-2 focus:outline-none focus:ring-sky-300 font-medium rounded-sm text-sm w-full sm:w-auto px-5 py-2.5 text-center cursor-pointer">Tambah Penduduk Sementara</button>
            </div>
