        ...
        <form wire:submit.prevent="pindah">
            ...
            <div class="grid gap-6 mb-6 md:grid-cols-2">
                    <div class="input-component">
                        ...
                        <input type="text" id="newNomorKK" wire:model.live.debounce.500ms="newNomorKK" class="bg-gray-50 border text-gray-900 font-medium text-sm rounded-sm block w-full p-2.5 @error('newNomorKK') border-red-500 focus:ring-red-500 focus:border-red-500 @else border-gray-400 focus:ring-blue-500 focus:border-blue-500 @enderror" placeholder="Masukan Nomor Kartu Keluarga Baru" autocomplete="off" />
                        <div class="h-0.25">
                    ...
                    <div class="input-component">
                        ...
                        <select id="newKepalaKeluarga" wire:model.live="newKepalaKeluarga" class="bg-gray-50 [&>option]:font-medium border text-gray-900 font-medium text-sm rounded-sm block w-full p-2.5 @error('pekerjaan') border-red-500 focus:ring-red-500 focus:border-red-500 @else border-gray-400 focus:ring-blue-500 focus:border-blue-500 @enderror">
