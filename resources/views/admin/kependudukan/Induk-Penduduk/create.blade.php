        ...
        <form wire:submit.prevent="store">
            <div class="grid gap-6 mb-6 md:grid-cols-2">
                <div class="input-component">
                    ...
                    <div class="h-0.25">
                        @error('nik') <span class="errorMsg text-red-500 font-semibold text-xs ml-3 italic">{{ "*".$message }}</span> @enderror 
                    </div>
                </div>
                <div class="input-component">
                    ...
                    <div class="h-0.25">
                        @error('jenis_kelamin') <span class="errorMsg text-red-500 font-semibold text-xs ml-3 italic">{{ "*".$message }}</span> @enderror 
                    </div>
                </div>
                <div class="input-component">
                    ...
                    <div class="h-0.25">
                        @error('nama_lengkap') <span class="errorMsg text-red-500 font-semibold text-xs ml-3 italic">{{ "*".$message }}</span> @enderror 
                    </div>
                </div>
                <div class="input-component">
                    ...
                    <div class="h-0.25">
                        @error('alamat') <span class="errorMsg text-red-500 font-semibold text-xs ml-3 italic">{{ "*".$message }}</span> @enderror 
                    </div>
                </div>
            ...
            <div class="grid gap-6 mb-6 md:grid-cols-4">
                <div class="md:col-span-2">
                    <label for="nomor_kk" class="block mb-2 text-sm font-semibold text-gray-950">Nomor Kartu Keluarga</label>
                    <input type="text" id="nomor_kk" wire:model.live="nomor_kk" class="bg-gray-50 border text-gray-900 font-medium text-sm rounded-sm block w-full p-2.5 @error('nomor_kk') border-red-500 focus:ring-red-500 focus:border-red-500 @else border-gray-400 focus:ring-blue-500 focus:border-blue-500 @enderror" placeholder="Masukan Nomor Kartu Keluarga " autocomplete="off" />
                    <div class="h-0.25">
                        @error('nomor_kk') <span class="errorMsg text-red-500 font-semibold text-xs ml-3 italic">{{ "*".$message }}</span> @enderror 
                    </div>
                </div>
                <div class="md:col-span-1">
                    ...
                    <div class="h-0.25">
                        @error('tempat_lahir') <span class="errorMsg text-red-500 font-semibold text-xs ml-3 italic">{{ "*".$message }}</span> @enderror 
                    </div>
                </div>
                <div class="md:col-span-1">
                    ...
                    <div class="h-0.25">
                        @error('tanggal_lahir') <span class="errorMsg text-red-500 font-semibold text-xs ml-3 italic">{{ "*".$message }}</span> @enderror 
                    </div>
                </div>
            </div>
            <div class="grid gap-6 mb-10 md:grid-cols-2">
                <div class="input-component">
                    ...
                    <div class="h-0.25">
                        @error('golongan_darah') <span class="errorMsg text-red-500 font-semibold text-xs ml-3 italic">{{ "*".$message }}</span> @enderror 
                    </div>
                </div>
                <div class="input-component">
                    ...
                    <div class="h-0.25">
                        @error('agama') <span class="errorMsg text-red-500 font-semibold text-xs ml-3 italic">{{ "*".$message }}</span> @enderror 
                    </div>
                </div>
                <div class="input-component">
                    ...
                    <div class="h-0.25">
                        @error('status_perkawinan') <span class="errorMsg text-red-500 font-semibold text-xs ml-3 italic">{{ "*".$message }}</span> @enderror 
                    </div>
                </div>
                <div class="input-component">
                    ...
                    <div class="h-0.25">
                        @error('pendidikan_terakhir') <span class="errorMsg text-red-500 font-semibold text-xs ml-3 italic">{{ "*".$message }}</span> @enderror 
                    </div>
                </div>
                <div class="input-component">
                    ...
                    <div class="h-0.25">
                        @error('pekerjaan') <span class="errorMsg text-red-500 font-semibold text-xs ml-3 italic">{{ "*".$message }}</span> @enderror 
                    </div>
                </div>
                <div class="input-component">
                    ...
                    <div class="h-0.25">
                        @error('baca_huruf') <span class="errorMsg text-red-500 font-semibold text-xs ml-3 italic">{{ "*".$message }}</span> @enderror 
                    </div>
                </div>
                <div class="input-component">
                    ...
                    <div class="h-0.25">
                        @error('kedudukan_keluarga') <span class="errorMsg text-red-500 font-semibold text-xs ml-3 italic">{{ "*".$message }}</span> @enderror 
                    </div>
                </div>
                <div class="input-component">
                    ...
                    <div class="h-0.25">
                        @error('dusun') <span class="errorMsg text-red-500 font-semibold text-xs ml-3 italic">{{ "*".$message }}</span> @enderror 
                    </div>
                </div>
                <div class="input-component">
                    <label for="" class="block mb-2 text-sm font-medium text-semibold-950">Asal Penduduk</label>
                    <input type="text" id="" wire:model.live="" class="bg-gray-50 border text-gray-900 font-medium text-sm rounded-sm block w-full p-2.5 @error('asal_penduduk') border-red-500 focus:ring-red-500 focus:border-red-500 @else border-gray-400 focus:ring-blue-500 focus:border-blue-500 @enderror" placeholder="Masukan Asal Penduduk " autocomplete="off" />
                    <div class="h-0.25">
                        @error('asal_penduduk') <span class="errorMsg text-red-500 font-semibold text-xs ml-3 italic">{{ "*".$message }}</span> @enderror 
                    </div>
                </div>
                <div class="input-component">
                    ...
                    <div class="h-0.25">
                        @error('tanggal_penambahan') <span class="errorMsg text-red-500 font-semibold text-xs ml-3 italic">{{ "*".$message }}</span> @enderror 
                    </div>
                </div>
            </div>
            <div class="flex justify-between mt-6">
                ...
                <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-2 focus:outline-none focus:ring-blue-300 font-medium rounded-sm text-sm w-full sm:w-auto px-5 py-2.5 text-center cursor-pointer">Tambah Penduduk</button>
            </div>
        </form>
    </div>
