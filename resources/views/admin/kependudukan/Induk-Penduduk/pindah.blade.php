    ...
    <div class="mx-4">
        ...
        <div class="flex flex-wrap justify-between items-center border-2 border-gray-300 rounded-sm my-6 p-4 gap-4 sm:justify-between">
            <div class="flex flex-wrap gap-2">
                ...
                <a href="{{ route('indukPenduduk') }}" type="button" class="cursor-pointer bg-sky-700 hover:bg-sky-800 text-white focus:ring-2 focus:outline-none focus:ring-sky-600 font-bold py-2 px-4 rounded flex items-center space-x-2 w-full sm:w-auto">
                ...
                <tbody id="tableBody">
                    ...
                    <tr class="page-row bg-white hover:bg-gray-300 transition duration-200 border-b-2 border-gray-300 @if($loop->index >= 10) hidden @endif" data-index="{{ $index }}">
                        ...
                        <td class="px-6 py-4 font-semibold flex space-x-4 justify-center">
                            ...
                            <a href="{{ route('indukPenduduk.mutasi.detail', $item->id_penduduk) }}" class="text-sky-600 hover:text-sky-900 font-medium transition rounded-sm duration-200 flex items-center space-x-1.5 cursor-pointer">
                            ...
                            <!-- Edit Button -->
                            <a href="{{ route('indukPenduduk.mutasi.edit', $item->id_penduduk) }}" class="text-green-600 hover:text-green-900 font-medium transition rounded-sm duration-200 flex items-center space-x-1.5 cursor-pointer">
