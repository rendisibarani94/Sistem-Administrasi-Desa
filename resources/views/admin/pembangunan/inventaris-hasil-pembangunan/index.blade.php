<div>
    ...
    <div class="mx-4">
        ...
        <div class="flex justify-between mx-4">
            ...
            <a href="/D3" class="cursor-pointer bg-sky-700 hover:bg-sky-800 text-white focus:ring-2 focus:outline-none focus:ring-sky-600 font-bold py-2 px-4 rounded flex items-center space-x-2 w-full sm:w-auto">
