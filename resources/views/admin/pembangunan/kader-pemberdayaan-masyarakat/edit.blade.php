    ...
    <div class="mx-6 mt-8">
        <form wire:submit.prevent="update">
                    ...
                    <div class="flex">
                        <div class="input-components flex-1 mr-2 cursor-pointer">
                            <div class="flex items-center px-2.5 border cursor-pointer rounded-sm border-gray-400">
                                <input id="bordered-radio-1" name="jenis_kelamin" type="radio" value="Laki-laki" wire:model.live="jenis_kelamin" class="w-4 h-4 text-blue-600 cursor-pointer bg-gray-100 focus:ring-blue-600 ring-offset-gray-800 focus:ring-2 border-gray-400">
                                <label for="bordered-radio-1" class="w-full py-2.5 ml-2 text-sm font-medium text-gray-900 cursor-pointer">Laki-laki</label>
                            </div>
                        </div>
                        <div class="input-components flex-1 mr-2 cursor-pointer">
                            <div class="flex items-center px-2.5 border cursor-pointer rounded-sm border-gray-400">
                                <input id="bordered-radio-2" name="jenis_kelamin" type="radio" value="Perempuan" wire:model.live="jenis_kelamin" class="w-4 h-4 text-blue-600 cursor-pointer bg-gray-100 focus:ring-blue-600 ring-offset-gray-800 focus:ring-2 border-gray-400">
            ...
            <div class="flex justify-between mt-6">
                <a href="{{ route('KaderPemberdayaanMasyarakat') }}" class="text-white text-center bg-teal-700 hover:bg-teal-800 focus:ring-2 focus:outline-none focus:ring-teal-600 font-medium rounded-sm text-sm w-full sm:w-auto px-5 py-2.5 cursor-pointer">Kembali</a>

                <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-2 focus:outline-none focus:ring-blue-300 font-medium rounded-sm text-sm w-full sm:w-auto px-5 py-2.5 text-center cursor-pointer">Ubah Data Kader</button>
            </div>
        </form>
    </div>
</div>
