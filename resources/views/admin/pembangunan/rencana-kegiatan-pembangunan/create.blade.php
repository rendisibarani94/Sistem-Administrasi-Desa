        ...
        <form wire:submit.prevent="store">
            <div class="grid gap-6 mb-6 md:grid-cols-2">
                ...
                <div class="input-component">
                    ...
                    <div class="flex">
                        <div class="input-component flex-1 mr-2 cursor-pointer">
                            <div class="flex items-center px-2.5 border cursor-pointer rounded-sm border-gray-400 @error('sifat_proyek') border-red-500 focus:ring-red-500 focus:border-red-500 @else border-gray-400 focus:border-blue-500 @enderror">
                ...
                <div class="input-component">
                    ...
                    <div class="flex">
                        <div class="input-component flex-1 mr-2 cursor-pointer">
                            <div class="flex items-center px-2.5 border cursor-pointer rounded-sm border-gray-400 @error('status_pengerjaan') border-red-500 focus:ring-red-500 focus:border-red-500 @else border-gray-400 focus:border-blue-500 @enderror">
                                <input id="bordered-radio-3" name="status_pengerjaan" type="radio" value="Belum Dimulai" wire:model.live="status_pengerjaan" class="w-4 h-4 text-blue-600 cursor-pointer bg-gray-100 focus:ring-blue-600 ring-offset-gray-800 focus:ring-2 border-gray-400 ">
                                <label for="bordered-radio-3" class="w-full py-2.5 ml-2 text-sm font-medium text-gray-900 cursor-pointer">Belum Dimulai</label>
                            </div>
                        </div>
                        <div class="input-component flex-1 mr-2 cursor-pointer">
                            <div class="flex items-center px-2.5 border cursor-pointer rounded-sm border-gray-400 @error('status_pengerjaan') border-red-500 focus:ring-red-500 focus:border-red-500 @else border-gray-400 focus:border-blue-500 @enderror">
                                <input id="bordered-radio-4" name="status_pengerjaan" type="radio" value="Sedang Dikerjakan" wire:model.live="status_pengerjaan" class="w-4 h-4 text-blue-600 cursor-pointer bg-gray-100 focus:ring-blue-600 ring-offset-gray-800 focus:ring-2 border-gray-400 ">
                        ...
                        <div class="input-component flex-1 mr-2 cursor-pointer">
                            <div class="flex items-center px-2.5 border cursor-pointer rounded-sm border-gray-400 @error('status_pengerjaan') border-red-500 focus:ring-red-500 focus:border-red-500 @else border-gray-400 focus:border-blue-500 @enderror">
                                <input id="bordered-radio-5" name="status_pengerjaan" type="radio" value="Selesai" wire:model.live="status_pengerjaan" class="w-4 h-4 text-blue-600 cursor-pointer bg-gray-100 focus:ring-blue-600 ring-offset-gray-800 focus:ring-2 border-gray-400 ">
                ...
                <div class="input-component">
                    ...
                    @endif
                    <!-- File Input -->
                    <input id="dokumentasi" wire:model="dokumentasi" accept="image/*" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-sm cursor-pointer bg-gray-50 focus:outline-none file:cursor-pointer file:bg-blue-600 file:border-0 file:me-4 file:py-2 file:px-4 file:text-sm file:text-white file:font-semibold @error('dokumentasi') border-red-500 @enderror" type="file">
                    {{-- Error Message --}}
                    <div class="h-0.25">
                        @error('dokumentasi')
                        <span class="errorMsg text-red-500 font-semibold text-xs italic">{{ "*".$message }}</span>
            ...
            <div class="flex justify-between mt-6">
                ...
                <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-2 focus:outline-none focus:ring-blue-300 font-medium rounded-sm text-sm w-full sm:w-auto px-5 py-2.5 text-center cursor-pointer">Tambahkan Kegiatan Pembangunan</button>
            </div>
        </form>
    </div>
</div>
