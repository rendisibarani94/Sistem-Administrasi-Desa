...
@php
    ...
    $arrowTransform = $isAnyChildActive ? 'rotate-90' : '';
    $arrowClasses = $arrowBaseClasses . ' ' . $arrowTransform;

    // Dropdown content classes
    $dropdownClasses = !$isAnyChildActive
        ? 'hidden py-2 space-y-2 transition-all duration-300 ease-in-out overflow-hidden'
