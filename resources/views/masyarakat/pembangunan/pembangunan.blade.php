...
<div>
    <div class="pembangunan pt-6 md:pt-10 px-4 sm:px-6 md:px-15">
        <h1 class="text-sky-700 font-bold text-xl sm:text-2xl md:text-3xl flex items-center space-x-2 mb-4 md:mb-8">
            <svg class="w-6 h-6 sm:w-7 sm:h-7 text-sky-700" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
