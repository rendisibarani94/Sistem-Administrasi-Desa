        ...
        <div class="pengumuman-item-wrapper mb-4 md:mb-6 border-2 border-gray-300 p-2 rounded-xs shadow-sm shadow-slate-400">
            <div class="pengumuman-item flex flex-col sm:flex-row items-start gap-3">
                <div class="image w-full sm:w-1/3 md:w-1/4">
                    <img src="{{ asset('images/masyarakat/berita.png') }}" alt="Upacara HUT" class="w-full h-auto object-cover p-2 sm:p-5" />
                </div>
            ...
            <div class="desc pl-2 sm:pl-5 pr-2 sm:pr-10">
                <p class="text-base sm:text-lg text-justify mb-2">
                ...
                <a class="cursor-pointer text-blue-600 text-xs sm:text-sm underline hover:text-blue-800" data-modal-target="default-modal" data-modal-toggle="default-modal">
