    ...
    <div class="mx-4">
        ...
        <section class="terkait px-4 md:px-8 lg:px-36 py-8 md:py-12 bg-white grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 items-center">
            ...
            <div class="flex justify-center mt-4 md:mt-0">
                <img src="{{ asset('images/peta_hutabulu_mejan.png') }}" alt="Profil Desa Sosor Dolok" class="w-full max-w-full md:max-w-lg h-48 md:h-64 object-contain rounded-md shadow">
            </div>
