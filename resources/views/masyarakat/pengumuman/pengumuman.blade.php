...
<div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-5 py-10 px-5">
                ...
                <div class="container">
                    <div class="pengumuman-item flex flex-col sm:flex-row items-start gap-3 mb-4 border-2 border-gray-300 p-2 rounded-xs shadow-sm shadow-slate-400">
                        ...
                        <div class="desc w-3/4 self-start p-5">
                            ...
                            <div class="pengumuman_date mb-16 flex items-center space-x-2">
                            ...
                            <a href="#" class=" text-teal-600 text-xs underline hover:text-teal-800">
                                Baca Selengkapnya
                            </a>
                        </div>
                    </div>
        ...
        <!-- Sidebar List Berita -->
        <section class="list_agenda md:col-span-1 p-5 border border-gray-300 shadow-md shadow-slate-400">
