    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-5 py-10 px-5">
        ...
        <section class="berita md:col-span-3 p-5 rounded-lg">
            ...
            <div class="gambar flex justify-center px-4 mb-6">
                <img src="{{ asset('storage/'.$pengumuman->gambar) }}" onerror="this.onerror=null; this.src='{{ asset('images/masyarakat/beranda.png') }}';" alt="Profil Desa Sosor Dolok" class="w-full max-w-md sm:max-w-lg md:max-w-xl lg:max-w-2xl object-cover shadow rounded-xs">
            </div>
