        ...
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto px-4 py-3">
            ...
            <div class="hidden w-full md:block md:w-auto" id="navbar-dropdown">
                <ul class="flex flex-col md:flex-row md:space-x-4 lg:space-x-6 xl:space-x-8 mt-4 md:mt-0 text-sm md:text-base">
                    ...
                    <!-- APBDes Dropdown -->
                    <li class="relative">
                        <button id="apbdesDropdownButton" data-dropdown-toggle="apbdesDropdown" class="flex items-center justify-between w-full py-2 px-3 text-white hover:bg-teal-600 md:hover:bg-transparent md:p-0 cursor-pointer transition-colors">
                            APBDes
                            <svg class="w-2.5 h-2.5 ml-1.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4" />
                            </svg>
                        </button>
                        <div id="apbdesDropdown" class="absolute z-10 hidden w-32 bg-white shadow-lg rounded-lg md:mt-2 overflow-hidden">
                            <ul class="py-2">
                                <li><a href="#" class="block px-4 py-2 text-gray-800 hover:bg-teal-600 hover:text-white transition-colors">2021</a></li>
                                <li><a href="#" class="block px-4 py-2 text-gray-800 hover:bg-teal-600 hover:text-white transition-colors">2022</a></li>
                                <li><a href="#" class="block px-4 py-2 text-gray-800 hover:bg-teal-600 hover:text-white transition-colors">2023</a></li>
                                <li><a href="#" class="block px-4 py-2 text-gray-800 hover:bg-teal-600 hover:text-white transition-colors">2024</a></li>
                            </ul>
                        </div>
                    </li>
                ...
                <div class="w-full md:w-96">
                    <div class="mb-6">
                        ...
                        <p class="text-white text-justify md:text-left text-sm md:text-base">
                            Sistem Informasi Desa Sosor Dolok, Website Resmi Pemerintah Desa Kerta, Kecamatan Sosor Gadong, Kabupaten Simalungun, Provinsi Sumatera Utara, Indonesia.
                        </p>
                    </div>
                    <div class="flex justify-center md:justify-start gap-4 text-white">
                        <a href="#" class="inline-flex items-center justify-center p-2 transition-opacity hover:opacity-80 border-2 rounded-full border-white">
