...
class AdminAgendaEditController extends Component
{
    ...
    #[Rule('max:150', message: 'Input Judul Agenda maksimal 150 karakter!')]
    public $judul;
    ...
    #[Rule('max:200', message: 'Input Tempat Agenda maksimal 200 karakter!')]
    public $tempat_agenda;

    #[Rule('required', message: 'Kolom Tujuan Agenda  Harus Diisi!')]
    #[Rule('max:255', message: 'Input Tujuan Agenda maksimal 255 karakter!')]
